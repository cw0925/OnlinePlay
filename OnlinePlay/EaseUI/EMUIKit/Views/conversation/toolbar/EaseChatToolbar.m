...
- (void)_setupSubviews
{
    ...
    [styleChangeButton setImage:[UIImage imageNamed:@"icon_duijiang"] forState:UIControlStateNormal];
    [styleChangeButton setImage:[UIImage imageNamed:@"icon_kyb"] forState:UIControlStateSelected];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"icon_xiaolian"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"icon_xiaolian"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"icon_kyb"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"icon_+"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"icon_+"] forState:UIControlStateHighlighted];
    [self.moreButton setImage:[UIImage imageNamed:@"icon_+"] forState:UIControlStateSelected];
