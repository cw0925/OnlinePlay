...
- (void)setupSubviewsForType:(EMChatToolbarType)type
{
    ...
    _photoButton = [self btnWithImage:[UIImage imageNamed:@"icon_phto"]
                     highlightedImage:[UIImage imageNamed:@"icon_phto"]
                                title:@"照片"];
    ...
    _takePicButton = [self btnWithImage:[UIImage imageNamed:@"icon_can"]
                       highlightedImage:[UIImage imageNamed:@"icon_can"]
                                  title:@"拍摄"];
